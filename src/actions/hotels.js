...
export const loadHotelsList = () => async (dispatch) => {
  try {
    dispatch({
      type: HOTELS_ARE_LOADING,
    });

    // let res = await axios.get(
    //   `https://qantashotels.com/api/v1/hotels`
    // );

    //Hard-coding the hotels list here instead of reading it off an api endpoint
    dispatch({
      type: HOTELS_LOADING_COMPLETE,
      payload: [
        {
          id: 'cxd650nuyo',
          property: {
